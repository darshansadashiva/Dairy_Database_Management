...
if (isset($_POST['updatestaffdata'])) {
    ...
    $sql = "UPDATE employee SET eid=$idupdate, ename='$ename', phno='$phno', address='$address', salary='$salary', designation='$designation' WHERE eid=$idupdate";
...
<form class="modal-content animate" action="" method="POST">
    <h3><b><u> Update Staff details</u></b> <a class="delete-icon" href="staff.php"> <i
                    class="fas fa-arrow-circle-left"></i></a></h3>
    <div class="container">
        ...
        <input type="text" name="phonenumber" value="<?php echo $arrdata['phno']; ?>" placeholder="Phone Number"
               required/>
        <br>
        <label for="staffaddress">Address<sup>*</sup> </label>
        <input type="text" name="staffaddress" value="<?php echo $arrdata['address']; ?>" placeholder="address"
               required/>
        <br>
        ...
        <input type="text" name="Designation" value="<?php echo $arrdata['designation']; ?>" placeholder="Designation"
               required/>
        <br>
